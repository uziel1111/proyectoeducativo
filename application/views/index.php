    ...
    <main role="main" class="flex-shrink-0">
      ...
      <div id="carouselhome" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <a href="<?= base_url('eduplena'); ?>">
              <img class="d-block w-100 img-fluid" src="<?= base_url('assets/img/home/slider/slider-eduplena.jpg'); ?>" alt="First slide">
            </a>
          </div>
          <div class="carousel-item">
            <a href="<?= base_url('Xv_aniversario') ?>">
      ...
      <!-- eduplena -->
      <section class="border-color-orange eduplena">
        <a class="text-decoration-none" href="<?= base_url('eduplena'); ?>">
          <div class="container">
            <div class="row align-items-center ">
              <div class="d-none d-md-block col-md-6 text-center">
                <img class="img-fluid" src="<?= base_url('assets/img/eduplena/banner-eduplena-left-img.png') ?>">
              </div>
              <div class="col-6">
                <img class="img-fluid banner-right" src="<?= base_url('assets/img/eduplena/banner-eduplena-right-img.png') ?>">
              </div>
            </div>
          </div>
        </a>
      ...
      <!-- Biblioteca -->
      <section class="compartimos">
        <a class="text-decoration-none" href="<?= base_url('Compartimos/'); ?>">
          <div class="container">
            <div class="row align-items-center ">
              <div class="d-none d-md-block col-md-6 text-center">
        ...
        <div class="container">
          ...
          <div class="row justify-content-center text-center no-gutters">
            ...
            <div class="col-md-6 col-lg-4" data-aos="flip-right" data-aos-delay="0" data-aos-duration="1000">
              ...
              <a href="<?= base_url('eduplena'); ?>" class="text-decoration-none" role="button" aria-pressed="true">
                <div class="card mb-3 sm-box-1">
                  <div class="row no-gutters align-items-center">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title font-weight-bold">Educación socioemocional</h5>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="container">
              <div class="row align-items-center no-gutters">
                <div class="col-lg-6 cc-light">
                  <h2>Educación socioemocional</h2>
                  <p>A través de EDUPLENA apoyamos la formación de personas felices con las habilidades necesarias para generar bienestar para sí mismo y los demás.</p>
                  <a href="<?= base_url('eduplena'); ?>" class="btn btn-lg btn-outline-secondary" role="button" aria-pressed="true">Leer más</a>
                </div>
                <div class="d-none d-lg-block col-lg-6"><img src="<?= base_url('assets/img/home/ct-slider/ct-slider-8.jpg'); ?>" class="img-fluid" alt="Responsive image"></div>
              </div>
            </div>
          </div>
          <div class="carousel-item">
