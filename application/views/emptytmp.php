      ...
      <nav class="navbar navbar-expand-lg text-uppercase fixed-top" id="mainNav">
          <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top" id="mainLogo">
              <img src="../../assets/img/template/Logo-Proyed-500-x-134.png" class="img-fluid" alt="Proyecto Educativo Logo">
            </a>
      ...
      <div id="carouselhome" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block h-100 w-100 img-fluid" src="../../assets/img/home/slider/slider-1.jpg" alt="First slide">
            <div class="carousel-caption d-none d-md-block" >
              <h2 class="font-weight-bold">Some title for Slide 1</h2>
              <h4>Some additional text for slide 1</h4>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-fluid" src="../../assets/img/home/slider/slider-2.jpg" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
              <h2 class="font-weight-bold">Some title for Slide 2</h2>
              <h4>Some additional text for slide 2</h4>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-fluid" src="../../assets/img/home/slider/slider-3.jpg" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h2 class="font-weight-bold">Some title for Slide 3</h2>
              <h4>Some additional text for slide 3</h4>
            </div>
          </div>
        </div>
  ...
  <section class="page-section text-white mb-0" id="about">
      ...
      <section class="page-section mb-0" id="news">
        ...
        <div class="row mt-5">
          <div class="col">
              <div class="card">
                  <img src="../../assets/img/home/news/news-4.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
          ...
          <div class="col">
              <div class="card">
                  <img src="../../assets/img/home/news/news-1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="#" class="btn btn-primary">Go somewhere</a>
          ...
          <div class="col">
              <div class="card">
                  <img src="../../assets/img/home/news/calendario2019.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="#" class="btn btn-primary">Go somewhere</a>
    ...
    <footer class="footer mt-auto">
      <div class="row mx-0 mb-neg30">
        <div class="col">
        <div class="container float-footer">
          <div class="row text-center">
            <div class="col">
                <blockquote class="blockquote">Educación con calidad para todos</blockquote>
              </div>
          </div>
