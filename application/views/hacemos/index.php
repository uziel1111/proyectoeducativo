          ...
          <div class="row px-5" id="row-bright-1" data-aos="zoom-in">
            ...
            <div class="row justify-content-center text-center mt-5" id="hacemos">
              ...
              <div class="col box" data-aos="flip-right" data-aos-delay="200" data-aos-duration="1000">
                ...
                <h4 class="service-heading fc-5">Educación socioemocional</h4>
                <p class="text-muted px-4">Para formar personas felices con las habilidades necesarias para generar bienestar para sí mismo y los demás.</p>
                <a class="btn bc-5 text-white" href="<?= base_url('eduplena'); ?>" role="button">Leer mas</a>
              </div>
              ...
              <div class="col box" data-aos="flip-right" data-aos-delay="200" data-aos-duration="1000">
                ...
                <h4 class="service-heading text-info">Sistemas de información educativa</h4>
                ...
                <a class="btn btn-info text-white" href="<?= base_url('Hacemos/Sistemas_Informacion'); ?>" role="button">Leer mas</a>
              </div>
              <div class="col box" data-aos="flip-right" data-aos-delay="300" data-aos-duration="1000">
                <span class="fa-stack fa-3x icon">
                ...
                <h4 class="service-heading text-success">Descarga administrativa</h4>
                ...
                <a class="btn btn-success text-white" href="<?= base_url('Hacemos/Descarga_Administrativa'); ?>" role="button">Leer mas</a>
              </div>
              <div class="col box" data-aos="flip-right" data-aos-delay="200" data-aos-duration="1000">
                <span class="fa-stack fa-3x icon">
                <i class="fas fa-circle fa-stack-2x fc-2"></i>
                ...
                <h4 class="service-heading fc-2">Optimización de recursos</h4>
