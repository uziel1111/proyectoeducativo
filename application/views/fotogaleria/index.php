      ...
      <div class="container p-0">
          <div class="row px-5 py-4 no-gutters" >
              <div class="col-lg-12 my-auto text-justify" data-aos="zoom-in">
               <center><h3 class="title-sec-xv">PROYECTO EDUCATIVO</h3></center>
                ...
                <div class="row padding-row">
                  ...
                  <div class="col-sm-3">
                    <div class="card card-xv">
                      <div class="card-body cardbody-xv">
                        <p class="card-text">LINEAS DE CODIGO</p>
                        <h5 class="card-title num-xv counter">85,320</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
        ...
        <div class="row" id="row-secondary-2">
         ...
         <center><h3 class="font-weight-bold text-white mb-3">Celebrando 15 años de logros</h3></center>
