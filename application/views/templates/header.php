      ...
      <div class="container">
        <div class="position-relative">
          ...
          <a href="<?= base_url('xv_aniversario'); ?>">
            <p class="ribbon">
              <span class="text"><span class=""><i class="fas fa-birthday-cake cake"></i></span> Sección especial</span>
            </p>
          </a>
        </div>
        <div class="toggle">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link rounded" href="<?= base_url('Comunicamos/'); ?>">

                <span class="fa-layers fa-stack">
                  <i class="fas fa-circle fa-stack-2x holder"></i>
                  <i class="far fa-circle fa-stack-2x circle"></i>
                  <i class="fa fa-comment-alt fa-stack-1x icon"></i>
